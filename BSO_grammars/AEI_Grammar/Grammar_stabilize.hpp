...
namespace BSO { namespace Grammar
{
    ...
    void BP_grammar_3(Spatial_Design::MS_Conformal*, Building_Physics::BP_Simulation_Vars*);
		...
		#ifdef ZONING_HPP
		Zoning_Settings zoning_settings = read_zoning_settings("/home/kknopp/Documents/MSc_2023_Heuvelman/GUI/JH_Stabilization_Assignment_GUI_new/Settings/Zoning_Settings.txt"); // read the zoning settings file
	...
	#ifdef STABILIZE_HPP
		Stabilize_Settings stabilize_settings = read_stabilize_settings("/home/kknopp/Documents/MSc_2023_Heuvelman/GUI/JH_Stabilization_Assignment_GUI_new/Settings/Stabilize_Settings.txt"); // read the stabilize settings file
    ...
    {
        grammar_settings = read_grammar_settings("/home/kknopp/Documents/MSc_2023_Heuvelman/GUI/JH_Stabilization_Assignment_GUI_new/Settings/Grammar_Settings.txt"); // read the grammar settings file
        #ifdef SD_ANALYSIS_HPP
    ...
    { // if it is tried to make a building physics model with this grammar, then give an error
	    ...
	    void SD_grammar_3(Spatial_Design::MS_Conformal* CF, Structural_Design::SD_Analysis_Vars* SD)
	    {
	        ...
	        BSO::Structural_Design::read_SD_settings("/home/kknopp/Documents/MSc_2023_Heuvelman/GUI/JH_Stabilization_Assignment_GUI_new/Settings/SD_Settings.txt", SD);
	...
	std::cout << "i" << std::endl;
	    ...
	    void SD_grammar_zoning(Spatial_Design::MS_Conformal* CF, Structural_Design::SD_Analysis_Vars* SD)
	    {
			...
			for (unsigned int l = 0; l < Zoned.get_designs().size(); l++)
		    {
				...
				using namespace Structural_Design;
		        BSO::Structural_Design::read_SD_settings("/home/kknopp/Documents/MSc_2023_Heuvelman/GUI/JH_Stabilization_Assignment_GUI_new/Settings/SD_Settings.txt", SD); // read file with structural design settings
